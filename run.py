    ...
    with mic_manager as stream:
        ...
        while True:
            ...
            try:
                ...
                resume = True
                # if ('grpc._channel._Rendezvous: <_Rendezvous of RPC that terminated with:' in e.message):
                #     print('Resuming..')
                #     resume = True
                # elif not ('maximum allowed stream duration' in e.message or 'deadline too short' in e.message):
                #     raise
